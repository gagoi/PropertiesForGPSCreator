public class Utils {
	...
	static boolean existSubject = false, existRoom = false, existCommentary = false, existNetwork;
	public static String[] cList;
	public static IdRoom[] rList;
	public static IdSubject[] sList;
	public static Network[] nList;
	public static int[] s, c, r;
}